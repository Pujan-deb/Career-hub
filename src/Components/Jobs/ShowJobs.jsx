...
export default function ShowJobs({ jobs }) {
    const navigate = useNavigate();
    const GotoJob = (id) => {
        navigate(`/Singlejob/${id}`)
    }
    return (
        <div className='p-4 rounded-md space-y-3 shadow-lg'>
            ...
            <button className="w-[134px] p-3 font-medium text-white bg-gradient-to-r from-[#7E90FE] to-[#9873FF] rounded-md mt-3" onClick={() => GotoJob(jobs.id)}>Show details</button>
